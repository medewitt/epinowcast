...
As describe in the `epinowcast` project [README](./index.html), you will need to install cmdstanr which also has the ability to install CmdStan using an R interface. 
